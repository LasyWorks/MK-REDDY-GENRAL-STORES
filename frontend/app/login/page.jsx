...
function LoginForm() {
  ...
  async function handleRegister(e) {
    ...
    try {
      ...
      // Send fresh OTP so the user can get their access tokens
      await api.post("/auth/otp/send", { phone });
      setSuccess("Account created! Enter the new OTP to sign in.");
            ...
            <form onSubmit={handleSendOTP} className="space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1.5">
                  An OTP will be sent to verify your number — required in all cases
                </p>
              </div>
              ...
              <p className="text-center text-xs text-gray-500">
                New here? Just enter your number — we'll create your account after verification.
              </p>
            </form>
          )}
          ...
          {step === "otp" && (
            <form onSubmit={handleVerifyOTP} className="space-y-5">
              <div className="text-center">
                ...
                <button type="button" onClick={() => { setStep("phone"); setError(""); setSuccess(""); }}
